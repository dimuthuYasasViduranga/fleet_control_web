<template>
  <div class="event-timespan-tooltip">
    <table class="event-timespan-tooltip-table">
      <thead>
        <tr colspan="2">
          <th colspan="2">Report Event</th>
        </tr>
      </thead>
      <tbody>
        <tr>
...
export default {
  ...
  computed: {
    ...
    compliance() {
      const percent = (this.event.compliance || 0) * 100;
...
<style>
.event-timespan-tooltip {
  z-index: 10000;
}

.event-timespan-tooltip-table {
...
.event-timespan-tooltip-table th {
  font-weight: bold;
  text-align: center;
}

.event-timespan-tooltip-table thead {
  background-color: #444444bb;
}

.event-timespan-tooltip-table td {
  text-align: center;
}
